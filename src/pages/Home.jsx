      ...
      <div className="text-center mb-16">
        ...
        <div className="mt-8 flex items-center justify-center space-x-4">
          <div className="w-20 h-20 rounded-full overflow-hidden shadow-lg border-4 border-white">
            ...
            />
            <div className="w-full h-full bg-gradient-to-br from-pink-400 to-pink-500 hidden items-center justify-center text-white text-3xl">
              👩
            </div>
          </div>
          ...
          <div className="w-20 h-20 rounded-full overflow-hidden shadow-lg border-4 border-white">
            ...
            />
            <div className="w-full h-full bg-gradient-to-br from-teal-400 to-blue-500 hidden items-center justify-center text-white text-3xl">
              🧑
            </div>
          </div>
        </div>
